...
Para una variable continua, la tabla agrupada y el histograma también se pueden construir de tres formas. La manual te muestra los 5 pasos del diagrama de arriba uno por uno; `hist()` los automatiza; `ggplot2` te da el control fino para informes.
