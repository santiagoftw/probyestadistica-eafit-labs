...
**Paso 2 — Rango de cada playa:**
```{r}
range(playa_a)
range(playa_b)
```

**Paso 3 — Desviación estándar de cada playa:**
```{r}
sd(playa_a)
sd(playa_b)
```

**Paso 4 — Coeficiente de variación (para comparar dispersión relativa):**
```{r}
sd(playa_a) / mean(playa_a)  # Playa A
sd(playa_b) / mean(playa_b)  # Playa B
```
