...
1. **Falso** — la temperatura en °C es numérica pero de intervalo, no de razón.
2. **Falso** — es el error clásico del Tema 1: el tipo de dato en R no determina la escala estadística.
3. **Verdadero** — tiene un orden natural de severidad, aunque no una distancia numérica definida entre niveles.
:::
